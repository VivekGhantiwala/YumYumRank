...
" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 90" width="50" height="40" class="hamburger-icon">
        <rect class="rect1" x="55" width="45" height="5" fill="#000"></rect>
        <rect class="rect2" x="20" y="12" width="80" height="5" fill="#000"></rect>
        <rect class="rect3" x="0" y="24" width="100" height="5" fill="#000"></rect>
    </svg>
    <svg style="
    margin-top: 6px;
    height:100px;
" class="svg-line" height="90" width="50">
        <line x1="0" y1="40" x2="0" y2="500" stroke="black" stroke-width="2" />
    </svg>
    <?php if (isLoggedIn()): ?>
        <div class="profile-container">
            ...
            <div class="profile-dropdown" id="profileDropdown">
                <a href="http://localhost/MiniProject(Aman)/client/home/index.php"><i class="ri-home-4-line"></i>Home</a>
                <a href="http://localhost/MiniProject(Aman)/client/feedback/feedback.php"><i
                        class="ri-feedback-line"></i>Feedback</a>
                <!-- <a href="../user-profile/user.php"><i class="ri-user-line"></i>My Profile</a> -->
                <!-- <a name="logout" href=""><i class="ri-logout-box-line"></i>Logout</a> -->
                <!-- <a name="logout" href="#" onclick="logoutUser();"><i class="ri-logout-box-line"></i>Logout</a> -->
...
<style>
    ...
    .logo {
        ...
        text-align: center;
        /* Center the text */
        background: linear-gradient(90deg, #3B82F6, #10B981, #1F2937);
...
<script>
    ...
    function logoutUser() {
        ...
        if (confirm("Are you sure you want to logout?")) {
            // Redirect to PHP script for logout and session destruction
    ...
    function menuinfo() {
        ...
        homeContainer.addEventListener("mouseover", () => {
            ...
            gsap.to(".home-container button", {
                backgroundColor: "rgb(219, 219, 200)",
